...
1. Отрисовать отзывы и форму для нового отзыва(просто в ресторане, они сейчас закомментарены, нужно их вернуть, для этого правильно расположите use client и сделать серверную загрузку).
2. Сделать новые страницы:
    1. страницу со списком всех блюд - /dishes
        1. Отображает список блюд, просто названия - fetch('<http://localhost:3001/api/dishes>')
        2. По клику на название делаем переход на страницу этого блюда
    2. страницу с одним блюдом - /dishes/:dishId
        1. просто инфу о блюде рисуем
